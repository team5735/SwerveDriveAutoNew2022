...
public class RobotContainer {
  ...
  public RobotContainer() {
    ...
    swerveSubsystem.setDefaultCommand(new SwerveJoystickCmd(swerveSubsystem, () -> -driveController.getRawAxis(OIConstants.kDriverYAxis), () -> driveController.getRawAxis(OIConstants.kDriverXAxis), () -> driveController.getRawAxis(OIConstants.kDriverRotAxis), () -> !driveController.getAButton()));
  ...
  private void configureButtonBindings() {
    new JoystickButton(driveController, Button.kB.value).whenPressed(() -> swerveSubsystem.zeroHeading());
  }
  ...
  public Command getAutonomousCommand() {
    ...
    return new SequentialCommandGroup(
      ...
      new InstantCommand(() -> swerveSubsystem.stopAllModules())
      );
